...
# gunbot.at made with Jekyll
Gunbot.at on https://gunbot.at implemented via [Jekyll](https://jekyllrb.com/).


## Philosophy
I moved to Jekyll as a hobby-project to transform my websites into an easier to manage format where I could just use simple markdown without having to "hack around" in HTML.
...
## Free-to-use
You are free-to-use this template, provided that you keep a copyright / link to my Github project. 
...
:beer: **Please support me**: Although all my software is free, it is always appreciated if you can support my efforts on Github with a [contribution via Paypal][paypal] - this allows me to write cool projects like this in my personal time and hopefully help you or your business. If the above helped you in any way, then [follow me on Twitter](https://twitter.com/gerdnaschenweng) or send me some coins: 
```
